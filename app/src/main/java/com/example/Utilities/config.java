...
//    public static String url_get_all_events = "http://qav2.cs.odu.edu/swaroop/HCI/getEvents.php";
    public static String url_create_event = "http://localhost:8081/api/event/create";
    public static String url_get_all_events = "http://localhost:8081/api/event/nearby/";
