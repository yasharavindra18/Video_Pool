...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (!lats.isEmpty() && !longs.isEmpty()) {
                ...
                for (int i = 0; i < lats.size(); i++) {
                    addMarker(lats.get(i), longs.get(i), rec.get(i), id.get(i));
                }
    ...
    private void showMarker(@NonNull Location currentLocation) {
        ...
        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)).position(latLng));
        // Marker Click Adapter
    ...
    /*
     * This function opens mCamera on clicking on the event*/
    @Override
    public void onInfoWindowClick(Marker marker) {
        Log.i("result1", marker.getSnippet());
        Log.i("Opening mCamera", marker.getSnippet());
        Log.d(LOG_TAG, "--> Camera Button clicked! Checking for mCamera permissions");
